...
miconexion = _sqlite3.connect("DB_ART.db")
...
micursor.execute("CREATE TABLE ARTICULOS ('ID' INTEGER PRIMARY KEY AUTOINCREMENT,'RUBRO' VARCHAR (50),'SUBRUBRO' VARCHAR (50),'DESCRIPCION' VARCHAR (200),'MARCA' VARCHAR (50),'UNIDAD_MEDIDA' VARCHAR (50),'STOCK_ALERTA' INTEGER,'PROVEEDOR_HABITUAL' VARCHAR (50),'DETALLE_UBICACION' VARCHAR (50))")
