...
def downloadDataFromNFS():
    ...
    NFSpath = f"./2024-original/{year}/{day}/"
    ...
    try:    
        subprocess.run([ "cp", "-r", NFSpath, finalLocalPath ] , check=True)
...
print("\n\t *** DATA MANAGER *** \n")
res = input("Type: \n- 1 for downloading passScripts data or \n- 2 for uploading processed passScript:   ")
